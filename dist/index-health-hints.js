 ...
 */
export function buildIndexRefusalHint(vaultPath, health) {
    const sample = health.missingSample.map((notePath, i) => `${i === 0 ? '  sample:  ' : '           '}${notePath}`);
    return [
 ...
 */
export function buildSearchIndexWarning(health) {
    if (!health.refused) {
        return undefined;
    }
    return {
...
//# sourceMappingURL=index-health-hints.js.map